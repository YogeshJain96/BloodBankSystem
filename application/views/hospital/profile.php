        ...
        <div class="row">
         ...
         <div class="col-lg-12">
            ...
            <div class="col-lg-6">
                  ...
                  ."<br>Address : ".$_SESSION['address'] 
                  					?>			
                  </h5>
                  <hr>
        <!-- Add and Update Blood Info -->
                  <a class="btn btn-danger btn-lg" href="<?php echo base_url(); ?>index.php/hospital/updateblood">Add Blood Info</a>	
          <!-- View Blood Request -->
                  <a class="btn btn-danger btn-lg" href="<?php echo base_url(); ?>index.php/hospital/showbloodrequests">View Blood Requests</a>  
